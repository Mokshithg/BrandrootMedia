    ...
    <div className="text-white md:my-44 my-16 mx-0 mt-0 mb-0">
      <div className="flex md:flex-row flex-col justify-between">
        ...
        <div className="relative left-[350px] top-32 md:top-0 md:left-0 ">
          <div className="md:w-56 w-32 md:h-56 h-32 relative md:bottom-24 bottom-32 right-72 md:right-27">
            <ImageCubeEffect
              images={images[1]}
              style={"md:h-56 h-32 w-full object-cover rounded-full"}
            />
          </div>
          <div className="h-28 md:h-48 w-28 md:w-48 relative bottom-56 right-28 md:right-0 md:left-30">
            <ImageCubeEffect
              images={images[2]}
              style={"md:h-48 h-28 w-full object-cover rounded-full"}
            />
          </div>
          <div className="w-44 md:w-64 h-44 md:h-64 relative bottom-56 right-56 md:left-50">
            <ImageCubeEffect
              images={images[3]}
