...
export default function Results() {
  return (
    <div className="mx-5 my-64 mt-8" id="results">
      <h1 className="font-poppins text-3xl md:text-6xl font-poppins text-[4vh] font-[700] mt-36 mb-14">
      ...
      <div className="md:w-[65%] w-full relative ml-4 md:left-96 md:-ml-12 mx-auto">
        <TiltCard
          image={
