    ...
    <div className="flex flex-col custom-shadow border-2 border-white-800 rounded-[15px] p-1">  
      <div className="flex flex-col items-center border-2 border-yellow-700 gap-4 custom-shadow p-6 md:p-12 rounded-[14px] bg-white h-full w-full relative">
        ...
        <div className="pb-10 border-b border-white">
          {p && (
            <p className="text-[17px] text-black md:text-[15px] md:overflow-auto scrollable-div md:px-4 md:h-30 tracking-wide font-poppins">
              {p}
            </p>
          )}
        </div>  
        ...
        <div className="-mb-8 text-right">
          <h1 className="text-2xl md:text-2xl md:h-8 mb-4 font-poppins text-black">
            - {name}
          </h1>
